...
<head>
    ...
    <link rel="stylesheet" href="../../../CSS/Profesores/fontawesome-all.min.css">
    <link rel="stylesheet" href="../../../CSS/Profesores/estilo.css">
    <link rel="stylesheet" href="../../../CSS/Profesores/es.css">
</head>
                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"  id="rol" name="rol" class="form-control" placeholder="Escribe el rol, 1 Docente, 2 Psicologo.." value="<?php echo $usuario['rol'];?>" required>
